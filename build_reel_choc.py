...
def chip_layer(text):
    fh=40; flag=flag_de(fh); tf=font(800,30); pad=24
...
wafer=prep("milka_wafer.jpg",165,-9)
bubbly=prep("milka_bubbly.webp",330,8)
specs=[(wafer,455,1130,10,0.0,False,0),(bubbly,640,1380,22,math.pi,True,1)]
build(specs,"FERSK SJOKOLADE","reel_sjokolade.mp4",chip=("FRA TYSKLAND",780,720,44))
